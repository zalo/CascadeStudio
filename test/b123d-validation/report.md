...
Generated 2026-08-13T18:45:56.406Z - 129 scripts (126 scored, 3 excluded because real build123d fails natively).
...
| `other: Line 6523: Uncaught Error: Python JavascriptError: INTERNAL OPENCASCADE ERROR in FilletEdges: the OC` | 1 |
...
- examples/toy_truck: `other: Line 6523: Uncaught Error: Python JavascriptError: INTERNAL OPENCASCADE ERROR in FilletEdges: the OC`
