...
Generated 2026-08-21T07:30:11.024Z - 232 scripts (222 scored, 10 excluded because real build123d fails natively).
...
| `other: Line 11839: Uncaught Error: INTERNAL OPENCASCADE ERROR: the OCCT kernel threw 'Not a wire shape!' (a` | 1 |
| `RuntimeError: KNOWN OCCT 8.0.1 wasm kernel fault: fuse dropped an operand (result volume 0.025` | 1 |

## Mismatches (runs, but geometry differs)

- **examples/bicycle_tire**
  - 'tire' volume 913915.947 vs 906269.110 (0.84%)
- **examples/joints**
...
- **examples/projection_algebra**
  - 'projected_text' bbox[0] -49.7713 vs -49.6470 (d=0.1243)
- **general_examples_algebra/ex08**
  - 'ex8' bbox[0] -100.0000 vs 0.0000 (d=100.0000)
- **docs/objects_1d**
  - 'double_tangent' bbox[3] 9.0087 vs 10.0000 (d=0.9913)
...
- ttt/ttt-23-02-02-sm_hanger: `other: Line 11839: Uncaught Error: INTERNAL OPENCASCADE ERROR: the OCCT kernel threw 'Not a wire shape!' (a`
- ttt/ttt-24-SPO-06-Buffer_Stand: `RuntimeError: KNOWN OCCT 8.0.1 wasm kernel fault: fuse dropped an operand (result volume 0.025`
