...
var Stack = /*#__PURE__*/function (_AbstractContentItem) {
  ...
  function Stack(layoutManager, config, parent) {
    ...
    _this.header = new Header(layoutManager, _assertThisInitialized(_this));
  ...
  _createClass(Stack, [{
    ...
    value: function dock(mode) {
      if (this._header.dock) if (this.parent instanceof RowOrColumn) this.parent.dock(this, mode);
    }
  }, {
    key: "setSize",
